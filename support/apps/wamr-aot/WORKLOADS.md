...
sampler when available). The documented Python command remains the developer
CLI until the separate validator installation and caller cutover PRs; it cannot
prepare an image. Neither validation path admits boot or measurement evidence.
